...
3. 优先跑 `meeting-asr project speakers review` 进入 TUI。它顶部会显示 project 概况、match/manual/capture/embed 进度、match 分数和 conflict/mismatch；下方两栏用于切 speaker/sample、样例翻页、播放当前样例、接受 match、输入新名字并保存。
