...
def _resolve_help_command(root_command: Any, command_path: tuple[str, ...]) -> Any:
    """
    Resolve a nested command path for ``meeting-asr help``.

    Args:
        root_command: Root Typer command generated by Typer.
        command_path: Nested command names.

    Returns:
        Typer command whose help should be printed.
    """
