...
- `presentation/cli/i18n.py`: locale/env/root-option language selection for Meeting-ASR-owned help.
- `presentation/cli/help.py`: localized renderer behind root help and `meeting-asr help`.
